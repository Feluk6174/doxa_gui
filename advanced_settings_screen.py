...
class AdvancedSettings (Screen):
    def __init__(self, sm, **kwargs):
        ...
        self.tor_buton = Button (border = (0, 0, 0, 0), size_hint = (1, 0.1), text = "Tor:"+str(self.advanced_settings["tor"]), on_release = self.togle_tor)
        self.main_all_box.add_widget(self.tor_buton)
        

        self.tor_text = Label(size_hint = (1, 0.1), text = functions.adapt_text_to_window("Enabeling tor will improve your anonimity but will make the app a lo slower. This setting is not reversable.", 15, Window.size[1]))
