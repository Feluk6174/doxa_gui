...
class AdvancedSettings (Screen):
    def __init__(self, sm, **kwargs):
        ...
        text = functions.adapt_text_to_window("To improve your anonimity. Slows down app. Not reversable. Currently not implemented.", int(15/400*Window.size[0]), Window.size[0])
        ...
        text = functions.adapt_text_to_window("Encrypt every post you post. Friends have to input your key manually. Not reversable.", int(15/400*Window.size[0]), Window.size[0])
        self.tor_text = Button(size_hint = (1, 0.1), border = (0, 0, 0, 0), color = (0, 0, 0, 1), background_normal = "./images/brick_dark.png", background_down = "./images/brick_dark.png", text = text)
        self.main_all_box.add_widget(self.tor_text)
