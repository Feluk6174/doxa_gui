...
class AddEncrypted (Screen):
    def __init__(self, sm, **kwargs):
        ...
        self.user_name_label = Label(size_hint = (1, 0.5), text = "User name:")
        ...
        self.key_label = Label(size_hint = (1, 0.5), text = "key:")
        ...
        self.done_buton = Button (border = (0, 0, 0, 0), size_hint = (1, 1), text = "Remove", on_release = self.remove)
        self.main_all_box.add_widget(self.done_buton)

        self.done_buton = Button (border = (0, 0, 0, 0), size_hint = (1, 1), text = "Add", on_release = self.add)
        self.main_all_box.add_widget(self.done_buton)

        self.done_buton = Button (border = (0, 0, 0, 0), size_hint = (1, 1), text = "Done", on_release = self.done)
        self.main_all_box.add_widget(self.done_buton)
