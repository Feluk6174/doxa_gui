...
class AddEncrypted (Screen):
    def __init__(self, **kwargs):
        ...
        self.user_name_textinput = TextInput(text='', multiline=False, background_normal = './images/paper_base.png', background_disabled_normal = './images/paper_base.png')
        ...
        self.key_textinput = TextInput(text='', multiline=False, background_normal = './images/paper_base.png', background_disabled_normal = './images/paper_base.png')
